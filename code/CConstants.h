...
extern NSString * const kServerVendorClassName                       ;

extern NSString * const kServerLocation                             ;
extern NSString * const kServerLatitude                             ;
extern NSString * const kServerLongtitude                             ;


extern NSString * const kServerUserName                              ;
extern NSString * const kServerPassword                              ;
extern NSString * const kServerDistance                              ;
