        ...
        [self.serverUser createNewUserWithEmail:self.emailTextField.text
                                       ...
                                       password:self.passwordTextField.text
                                            ...
                                            [self.navigationController popViewControllerAnimated:YES];
                                              ...
                                              [UIAlertView showInformationWithTitle:@"Error" message:error.localizedDescription dismissTitle:@"OK"];
...
- (void)launchTabBarVC {
    ...
    CVendorListTableViewController *vendorListTVC = [CVendorListTableViewController new];
//    CPeopleTableViewController *peopleTVC = [CPeopleTableViewController new];
    UINavigationController *navigationControllerForPeople = [[UINavigationController alloc]initWithRootViewController:vendorListTVC];
    navigationControllerForPeople.title = @"Vendors";
...
- (void)loginWithFacebookAction {
    UIAlertView *alertView = [[UIAlertView alloc]initWithTitle:@"Error" message:@"Need to Implement" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
    [alertView show];
}
