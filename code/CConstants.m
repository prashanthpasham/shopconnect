...
NSString * const kServerDistance                            = @"distance";

NSString * const kServerLocation                            = @"location";
NSString * const kServerLongtitude                          = @"longitude";
NSString * const kServerLatitude                            = @"latitude";


// Parse : Contact class Name & Attributes

NSString * const kServerContactClassName                     = @"contact";
NSString * const kServerVendorClassName                      = @"vendor";
